...
<!--[if gt IE 8]><!-->
 <html class="no-js"> <!--<![endif]-->
	...
	<title>Új-Zéland</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Élmény beszámólo és blog Új-Zélandi utazásunkról." />
  ...
  <!-- 
	...
	<![endif]-->
	<!-- <style> -->
		<!-- @font-face { font-family: lotr; src: url('fonts\hobbitonbrushhand.ttf'); }  -->
		<!-- h1 { -->
         <!-- font-family: JuneBug -->
		<!-- } -->
	<!-- </style> -->
		...
		<header  id="fh5co-header">
			<div class="container">
				<nav class="fh5co-main-nav">
					<ul>
						<li><a href="menu"><span>Blog</span></a></li>
						<li class="fh5co-active"><a href="stat.php"><span>Statisztikák</span></a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12 fh5co-copyright text-center">
					<p><small> </small> <small>Made with care by mi :)</small></p>
				</div>
			</div>
		</div>
	<!-- </footer>
